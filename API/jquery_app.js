// this app is to provide additional developer tools and give ideas for user interface
  ...
  //debug control
      var debug ={"checking device width":[false,false],
                ...
                "interface object": [true,false,true]
                }
  ///////////////////////////////////////////////////////
  ...
  //  if a topic has an array, the first is general info the second is for boolean checking third is for debuggging tis basic function
